...
struct BookItem : Codable, Identifiable{
    ...
    public init?(dictionary: [String : Any]){
        ...
        self.init(title: bookTitle, author: authorName, imageURL: bookImage, description: bookDesc, publisher: bookPubName, rank:bookRank, rankLastWeek: bookWeekRank, weeksOnList: weekNumOnList)
    }
    
    init(title: String, author: String, imageURL: String, description: String,  publisher: String, rank: Int, rankLastWeek: Int, weeksOnList: Int) {
        self.title = title
        self.author = author
